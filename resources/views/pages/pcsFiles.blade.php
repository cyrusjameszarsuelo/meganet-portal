                                ...
                                @if ($publicFiles != '')
                                    @forelse ($publicFiles as $item)
                                        <a href="#"
                                            ...
                                            data-url="{{ asset('pcsFolder/' . $file . '/' . $item->getFilename()) }}"
                                            target="_blank">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 mt-2">
                        <a class="btn btn-warning text-white btn-block btn-lg " style="font-size: 14px; background-color: #000"
                            href="/pcs/powerpoint-presentation">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/pcsUpload/{{ $file }}" method="POST"
