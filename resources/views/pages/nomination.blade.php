    ...
    <div class="container mt-3">
        <span class="breadcrumbCustom"><a href="/home">HOME</a> <i class="fa fa-chevron-right ml-2 mr-2"></i>
            <a href="/nomination-mechanics">MECHANICS</a> <i class="fa fa-chevron-right ml-2 mr-2"></i> <span
                style="color:#ee2f21">NOMINATION</span></span>
    </div>
                ...
                <div class="col-12 col-lg-6 sigla-form" style="background-color: #0d0d0d; color: #ee2f21;">
                    ...
                    <form id="nominationForm">
                        ...
                        <div class="row mr-5 ml-5 mb-3">
                            <div class="col-md-6">
                                <h6 class="card-title">Nominee's Information:</h6>
                                <p class="card-text">
                                    <select class="form-select" id="nominee" required>
                                        <option selected disabled value="">-- SELECT NOMINEE -- </option>
                                        @foreach ($siglaNominees as $nominee)
                        ...
                        <div class="row mr-5 ml-5 mb-3">
                            ...
                            <div class="col-md-6">
                                <h6 class="card-title">Desirable Behavior:</h6>
                                <p class="card-text">
                        ...
                        <div class="row mr-5 ml-5 mb-2">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" id="critical_incidents" style="height: 100px !important;"
