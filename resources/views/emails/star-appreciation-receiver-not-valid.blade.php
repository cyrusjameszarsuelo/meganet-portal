...
<head>
    <meta charset="utf-8">
    <title>You received a Mega Thank You Card from a colleague!</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background-color: #ffffff; border-radius: 10px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 20px 24px 12px 24px; font-size: 14px; color: #333333;">
                            ...
                            <p style="margin: 0 0 10px 0;">You received a Mega Thank You Card from <strong>{{ $entry->from_name }}</strong>!</p>
                            <p style="margin: 0 0 10px 0;">Keep up the great work and the positive impact you're making in Megawide!</p>
                        </td>
                    </tr>
